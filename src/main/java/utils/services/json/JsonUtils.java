...
import static utils.services.constans.GeneralConstant.ARCHIVO_JSON_DEFAULT;
import static utils.services.constans.GeneralConstant.ARCHIVO_JSON_FORMAT;
import static utils.services.constans.GeneralConstant.RESPONSE;
import static utils.services.constans.GeneralConstant.SEPARADOR;
...
public class JsonUtils {
    ...
    public static String jsonModify(String filePath, List<String> tags, List<String> values) {
        ...
        try {
            jObject = (JsonObject) new JsonParser().parse(new FileReader(filePath));
